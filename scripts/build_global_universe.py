...
US_CURATED = {
    ...
    "NVDA":  ("NVIDIA Corporation",             "Technology & Semiconductors",   230.36, "$3.15T",  54.2, 0.08),
    "AAPL":  ("Apple Inc.",                     "Consumer Electronics & Tech",   319.97, "$3.44T",  33.8, 0.44),
    "MSFT":  ("Microsoft Corporation",          "Software & Cloud",             499.70, "$3.11T",  34.6, 0.72),
    "AMZN":  ("Amazon.com, Inc.",               "E-Commerce & Cloud AWS",       182.40, "$1.90T",  41.5, 0.0),
    "GOOGL": ("Alphabet Inc. (Google Class A)", "Internet & Digital Tech",      338.46, "$2.06T",  23.1, 0.48),
    ...
    "MSFT":  ("Microsoft Corporation",          "Software & Cloud",             499.70, "$3.11T",  34.6, 0.72),
    "CAT":   ("Caterpillar Inc.",               "Industrials & Machinery",      813.94, "$172.4B", 16.2, 1.55),
    "MCD":   ("McDonald's Corporation",          "Restaurants & Food",           255.69, "$210.5B", 25.8, 2.30),
    "V":     ("Visa Inc.",                      "Banking & Financials",         375.07, "$564.2B", 29.5, 0.75),
    "CRM":   ("Salesforce, Inc.",               "Software & Cloud",             254.80, "$244.6B", 42.0, 0.63),
    "AMGN":  ("Amgen Inc.",                     "Healthcare & Biotech",         318.20, "$170.8B", 16.8, 2.80),
    "BA":    ("The Boeing Company",             "Industrials & Aerospace",      212.25, "$99.8B",  0.0,  0.0),
    "HON":   ("Honeywell International Inc.",   "Industrials & Aerospace",      208.50, "$136.2B", 22.4, 2.10),
    "IBM":   ("International Business Machines","Technology & Enterprise IT",   234.89, "$176.5B", 21.0, 3.45),
    "AXP":   ("American Express Company",       "Banking & Financials",         326.16, "$179.2B", 18.5, 1.15),
    "JPM":   ("JPMorgan Chase & Co.",           "Banking & Financials",         358.64, "$622.1B", 12.3, 2.10),
    "TRV":   ("The Travelers Companies, Inc.",  "Banking & Insurance",          232.50, "$53.2B",  12.8, 1.80),
    "CVX":   ("Chevron Corporation",            "Energy & Natural Resources",   208.60, "$272.4B", 14.2, 4.45),
    "SHW":   ("The Sherwin-Williams Company",   "Industrials & Materials",      362.40, "$91.5B",  32.0, 0.80),
    "JNJ":   ("Johnson & Johnson",              "Healthcare & Pharmaceuticals", 275.23, "$392.4B", 17.5, 3.00),
    "PG":    ("The Procter & Gamble Company",   "Consumer Goods",               146.44, "$406.2B", 27.4, 2.34),
    "MRK":   ("Merck & Co., Inc.",              "Healthcare & Pharmaceuticals", 118.50, "$300.2B", 16.5, 2.60),
    "DIS":   ("The Walt Disney Company",        "Telecom & Digital Media",       105.31, "$178.6B", 38.0, 0.77),
    "WMT":   ("Walmart Inc.",                   "Consumer & Retail",             107.14, "$631.8B", 33.2, 1.05),
    "KO":    ("The Coca-Cola Company",          "Food & Consumer Staples",       88.07, "$294.8B", 26.2, 2.80),
    ...
    "INTC":  ("Intel Corporation",              "Technology & Semiconductors",    95.80, "$87.5B",   0.0,  1.50),

    # ─── Additional NASDAQ-100 Tech, Biotech & Innovation Titans ───
    "AVGO":  ("Broadcom Inc.",                  "Technology & Semiconductors",  357.90, "$786.4B", 68.2, 1.30),
    ...
    "QCOM":  ("QUALCOMM Incorporated",          "Technology & Semiconductors",  168.74, "$188.4B", 16.4, 2.00),
    "TXN":   ("Texas Instruments Incorporated", "Technology & Semiconductors",  258.44, "$186.2B", 32.0, 2.55),
    "ADBE":  ("Adobe Inc.",                     "Software & Cloud",             266.51, "$252.0B", 46.2, 0.0),
    "INTU":  ("Intuit Inc.",                    "Software & Cloud",             332.70, "$181.2B", 62.0, 0.55),
    "AMAT":  ("Applied Materials, Inc.",        "Technology & Semiconductors",  198.50, "$164.2B", 23.5, 0.80),
    "BKNG":  ("Booking Holdings Inc.",          "Consumer & Retail",           193.29, "$134.5B", 28.5, 0.88),
    "ISRG":  ("Intuitive Surgical, Inc.",       "Healthcare & Medical Tech",    475.20, "$168.5B", 78.0, 0.0),
    "LRCX":  ("Lam Research Corporation",       "Technology & Semiconductors",  307.65, "$105.8B", 26.5, 1.00),
    "KLAC":  ("KLA Corporation",                "Technology & Semiconductors",  185.60, "$97.8B",  31.2, 0.80),
    ...
    "PDD":   ("PDD Holdings Inc. (Temu/Pinduoduo)","Consumer & Retail",         82.21, "$164.8B", 12.5, 0.0),
    "ABNB":  ("Airbnb, Inc.",                   "Consumer & Retail",            128.40, "$81.5B",  32.0, 0.0),
    "PLTR":  ("Palantir Technologies Inc.",     "Technology & AI Software",      174.33, "$70.8B",  200.0, 0.0),
    ...
    "CTAS":  ("Cintas Corporation",             "Industrials & Services",       200.47, "$79.8B",  48.0, 0.80),
    "NXPI":  ("NXP Semiconductors N.V.",        "Technology & Semiconductors",  227.84, "$61.2B",  22.0, 1.70),
    ...
    "PCAR":  ("PACCAR Inc",                     "Industrials & Machinery",       124.70, "$51.6B",  12.0, 3.20),
    ...
    "ODFL":  ("Old Dominion Freight Line",      "Industrials & Transport",      185.87, "$43.2B",  34.0, 0.50),
    "FAST":  ("Fastenal Company",               "Industrials & Wholesale",       49.60, "$41.5B",  36.0, 2.10),
    ...
    "SBUX":  ("Starbucks Corporation",          "Consumer & Restaurants",        104.47, "$107.2B", 26.5, 2.45),
    ...
    "MNST":  ("Monster Beverage Corporation",   "Food & Consumer Staples",       43.82, "$53.2B",  32.0, 0.0),
    "KDP":   ("Keurig Dr Pepper Inc.",          "Food & Consumer Staples",       32.59, "$50.8B",  21.0, 2.35),
    "KHC":   ("The Kraft Heinz Company",        "Food & Consumer Staples",       24.85, "$42.5B",  14.5, 4.60),
    ...
    "ARM":   ("Arm Holdings plc (ADR)",         "Technology & Semiconductors",  252.09, "$144.5B", 98.0, 0.0),
    ...
    "SNOW":  ("Snowflake Inc.",                 "Cloud Software & Data AI",     337.18, "$41.5B",  65.0, 0.0),
