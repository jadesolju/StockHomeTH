    ...
    highlights: [
      {
        ...
        keyTakeaways: ['AI Data Center revenue record', 'Growth in power electronics'],
        fullContent: 'DELTA รายงานผลประกอบการไตรมาสล่าสุดเติบโตแข็งแกร่งด้วยยอดขายกลุ่ม Data Center',
        region: 'thai',
        timeframe: 'daily',
        marketName: 'SET',
        date: 'วันนี้',
