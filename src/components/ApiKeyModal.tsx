  ...
  return (
    <div className="ios-sheet-overlay" onClick={onClose} style={{ alignItems: 'center', padding: '20px' }}>
      ...
      >
        ...
        {/* Info */}
        <div style={{ background: 'rgba(0, 122, 255, 0.08)', padding: '12px 14px', borderRadius: '12px', marginBottom: '16px', fontSize: '0.8rem', color: 'var(--text-secondary)', lineHeight: 1.5 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            style={{ fontSize: '0.78rem', color: 'var(--accent-blue)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '4px' }}
          >
