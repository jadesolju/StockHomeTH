...
-- 1. Register Migration in Supabase Migration History
insert into supabase_migrations.schema_migrations (version, name)
values ('20260914120000', 'stock_pool_analysis_schema')
on conflict (version) do nothing;

-- 2. Add Pool & Analysis Tracking Columns to public.stocks
...
-- 3. Create High-Performance Indexes for Batch Worker Queries
